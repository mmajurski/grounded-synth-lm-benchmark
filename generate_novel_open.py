...
if __name__ == '__main__':
    ...
    parser.add_argument('--sample_count', type=int, default=-1, help='number of total questions to generate, set to <=0 for all')
    parser.set_defaults(async_flag=True)

    args = parser.parse_args()
    print("Generating novel Open Ended Questions")
    print(args)
